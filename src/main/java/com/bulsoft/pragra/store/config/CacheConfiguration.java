package com.bulsoft.pragra.store.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("online_store");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("online_store");
        ...
        config.getMapConfigs().put("com.bulsoft.pragra.store.domain.*", initializeDomainMapConfig(jHipsterProperties));
